...
<?php  																														require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/app.class.php");	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/nav.class.php"); 	require_once($_SERVER['DOCUMENT_ROOT'] . "/eclipse.org-common/system/menu.class.php"); 	$App 	= new App();	$Nav	= new Nav();	$Menu 	= new Menu();		include($App->getProjectCommon());    # All on the same line to unclutter the user's desktop'
	...
	# Date:			2023-11-20
	#
	# Description: Eclipse project 4.30 release freeze plan
	#
	#
	#****************************************************************************
	...
	$pageTitle 		= "Eclipse 2023-12 (4.30) Endgame Plan";
	$pageKeywords	= "eclipse, 4.30, 2023-12, milestone, schedule, endgame";
...
?>		
	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			...
			<li><a href="https://www.eclipse.org/projects/project-plan.php?planurl=http://www.eclipse.org/eclipse/development/plans/eclipse_project_plan_4_30.xml">Eclipse Project 4.30 Plan</a></li>
			<li><a href="https://wiki.eclipse.org/Category:SimRel-2023-12">2023-12 Simultaneous Release</a></li>
			</ul>
      	</div>
		<div class="homeitem3col">
			<h3>What is the game plan?</h3>
			<p> 
	 		The Eclipse 2023-12 (4.30) release endgame involves building 
	        a series of release candidates leading to the Eclipse project's contribution to the
	        2023-12 (4.30) release. The Eclipse project version number for this release is 4.30.
			As always, we welcome help from the 
	        community with testing the release candidates. All new features and problems fixed in 2023-12 (4.30) are in the Eclipse github database.
	        </p> 

	        <p>General announcements during the 2023-12 (4.30) endgame are posted to the 
		   ...
		   <p>
	        ...
	        defects that we intend to fix for 2023-12 (4.30). At the end of RC2 build, 
	        there should not be any open defects tagged 4.30. All fixes submitted 
			...
			<strong>2023-12 (4.30) Release</strong>
			<p>The 2023-12 (4.30) release should be complete and available for download by 
	              December 6, 2023 as part of the <a href="https://github.com/eclipse-simrel/.github/blob/main/wiki/Simultaneous_Release.md">2023-12 Simultaneous Release</a>. If product teams intending 
	              to ship on 2023-12 (4.30) uncover further serious defects during the endgame, 
